...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_P7, KC_P8,   KC_P9,   KC_PMNS,
    _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_PGUP, KC_P4, KC_P5,   KC_P6,   KC_PPLS,
    _______, _______, _______, _______, _______, KC_PIPE, KC_QUES, KC_PGDN, KC_P1, KC_P2,   KC_P3,   KC_PSLS,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_P0, KC_PDOT, KC_PEQL, KC_PAST
),
