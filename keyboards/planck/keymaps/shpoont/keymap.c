...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______, KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______, _______, _______, _______, _______, _______, KC_PGDN, _______, _______, KC_VOLU, KC_MPLY,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_NUBS, KC_MRWD, KC_VOLD, KC_MNXT
),
